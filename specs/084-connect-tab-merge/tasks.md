...
- Whenever a **new** `method_url()` consumer is added in either repository, add its row to the contract's inventory table in the same change (B54). T054 is the backstop, not the mechanism.
